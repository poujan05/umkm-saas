...
if (loading) return <p>Loading...</p>
  ...
  <div>
    ...
    {/* FORM */}
    <div className="bg-white border p-4 rounded-2xl shadow mb-6 flex flex-col md:flex-row gap-3">
      <input
        type="text"
    ...
    <div className="grid md:grid-cols-2 gap-4">
      {products.map((product) => (
        <div
          key={product.id}
          className="bg-white border p-4 rounded-2xl shadow flex justify-between items-center"
        >
          <div>
